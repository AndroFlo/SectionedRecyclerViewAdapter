...
public class SectionedRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void setSections(List<? extends Object> listValues) {
        ...
        List<SectionedRecyclerViewAdapter.Section> listSection = findSections();
    ...
    private List<SectionedRecyclerViewAdapter.Section> findSections() {

        List<SectionedRecyclerViewAdapter.Section> listSection = new ArrayList<>();
